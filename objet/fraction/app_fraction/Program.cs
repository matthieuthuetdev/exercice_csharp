...
namespace app_fraction
{
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                fractionLibrary.Fraction af = new fractionLibrary.Fraction(0, 1);
                fractionLibrary.Fraction bf = new fractionLibrary.Fraction(0, 2);
            ...
            catch (CheckFraction erreure)
            {
                Console.Write(erreure.Message)
            }
